...
public class UserLoginActivity extends AppCompatActivity {
    ...
    private void gotoNextActivity() {
        ...
        Log.i(TAG, "User already logged in, starting Trip list activity");
    ...
    private void doUserLogin() {
            ...
            Log.i(TAG, "User not logged in, starting Facebook Login activity");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.i(TAG, "Getting result back from Facebook login, requestcode: " + requestCode + " & resultcode: " + resultCode);
        ...
        if(requestCode == Constants.FACEBOOK_LOGIN_REQUEST_KEY && resultCode == RESULT_OK){
            ...
            if(data.getExtras()!=null) {
                Log.i(TAG, "User current login status: " + User.getUser().isLogin());
                if(User.getUser().isLogin())
                    gotoNextActivity();
            }
